...
template<typename T>
concept decimal_value_type = std::same_as<T, decimal::decimal32> ||
                              std::same_as<T, decimal::decimal64> ||
                              std::same_as<T, decimal::decimal128>;

// signbit
// fpclassify
// isfinite

template<decimal_value_type T> bool isinf(T value);
template<decimal_value_type T> bool isnan(T value);
...
template<decimal_value_type T> bool samequantum(T x, T y);
